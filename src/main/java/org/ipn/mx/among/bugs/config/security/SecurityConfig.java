...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(c -> c.configurationSource(this.corsConfigSource())) // <--- Lo que te dijo Diego
    ...
    public CorsConfigurationSource corsConfigSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:4200")); // Más seguro que "*"
        config.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        // Agregamos "Accept-Language" para que tu API responda en español
